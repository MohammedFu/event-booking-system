...
async function registerRoutes() {
  ...
  await fastify.register(require('./routes/services'), { prefix: '/api/v1/services' });
  await fastify.register(require('./routes/bookings'), { prefix: '/api/v1/bookings' });
  await fastify.register(require('./routes/payments'), { prefix: '/api/v1/payments' });
  await fastify.register(require('./routes/provider'), { prefix: '/api/v1/provider' });
